        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs"><span class="mr-2"><a href="{{ URL::to('/trang-chu')}}">Trang chủ</a>
                            ...
                            href="/laptop-selling-website/danh-muc/{{ $products->menu->id }}-{{ Str::slug($products->menu->name) }}.html">{{ $products->menu->name }}</a></span>
                    <span></span></p>
        ...
        <form action="{{ URL::to('/them-gio-hang') }}" method="post">
            ...
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="{{ URL($products->thumb) }}" class="image-popup"><img src="{{ URL($products->thumb) }}"
