<nav class="navbar navbar-expand-lg ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="{{ URL::to('/trang-chu')}}">Laptop Website</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="main-menu navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="{{ URL::to('/lien-he')}}" class="nav-link">Liên hệ</a></li>
                <li class="nav-item cta cta-colored"><a href="{{ URL::to('/gio-hang')}}" class="nav-link"><span
