            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end"
                        style="background-image: url(public/template/users/images/lenovo.jpg);">
                        <div class="text px-3 py-1">
                            <h2 class="mb-0"><a
                                    href="/laptop-selling-website/danh-muc/4-lenovo.html">Lenovo</a>
                            </h2>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end"
                        style="background-image: url(public/template/users/images/hp.jpg);">
                        <div class="text px-3 py-1">
                            <h2 class="mb-0"><a
                                    href="/laptop-selling-website/danh-muc/3-hp.html">Hp</a>
                            </h2>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end"
                        style="background-image: url(public/template/users/images/asus.jpg);">
                        <div class="text px-3 py-1">
                            <h2 class="mb-0"><a
                                    href="/laptop-selling-website/danh-muc/1-asus.html">Asus</a>
                            </h2>
                        </div>
                    </div>
                </div>
